...
public class WebSecuriyConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecuriyConfig(Jwt jwt, JwtTokenConfigure jwtTokenConfigure, JwtAccessDeniedHandler accessDeniedHandler, EntryPointUnauthorizedHandler unauthorizedHandler) {
        this.jwt = jwt;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/**").hasRole(Role.USER.value())
                .anyRequest().permitAll()
            .and()
            // login page & login success url
             .formLogin()
                .disable();
        http
